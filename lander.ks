...
set FINALSTAGEHEIGHT to 5.

//if body = "Kerbin" { set GRAVITY to 9.81. }.
//if body = "Mun" { set GRAVITY to 1.1. }.

print "LANDER initiating for planet: " + body.
print "GRAVITY: " + GRAVITY.
print "DEACCELHEIGHT: " + DEACCELHEIGHT.
print "FINALAPPROACH: " + FINALAPPROACH.
print "TWR: " + MAXTHRUST / (MASS*GRAVITY).
...
until ALT:RADAR > testH OR STAGE:LIQUIDFUEL < 1{
	lock throttle to 1.
}
lock throttle to 0.
wait 1.
...
print "TWR: " + MAXTHRUST / (MASS*GRAVITY).
print "Waiting for DEACCELHEIGHT: " + DEACCELHEIGHT.
